...
const QuoteManager: React.FC<QuoteManagerProps> = ({ 
    ...
    `;
      ...
      return `
        <div style="padding: 40px; text-align: center;">
          ...
          <p style="color: #6b7280; font-size: 12px; margin-top: 20px;">Error: ${error.message}</p>
        </div>
      `;
    }
  };
  ...
  const handlePreviewQuote = async (quote: Quote) => {
    ...
    try {
      ...
      // Fallback to basic preview if template generation fails
      const fallbackHTML = `
        <div class="template-preview bg-white border-2 border-gray-200 rounded-xl p-8 shadow-lg">
          <div class="text-center mb-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-2">Quote Preview</h2>
            <p class="text-gray-600">Quote #${quote.id.split('-')[1]}</p>
          </div>
          
          <div class="space-y-4">
            <div class="bg-blue-50 p-4 rounded-lg">
              <h3 class="font-bold text-gray-800 mb-2">Client Information</h3>
            ...
            <div class="bg-green-50 p-4 rounded-lg">
              ...
              <p><strong>Users:</strong> ${quote.configuration.numberOfUsers}</p>
              <p><strong>Data Size:</strong> ${quote.configuration.dataSizeGB} GB</p>
    ...
    try {
      ...
      if (quote.templateUsed && quote.templateUsed.id !== 'default') {
        ...
        try {
          ...
          console.warn('⚠️ Could not use merged template, falling back to default:', error.message);
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 font-semibold flex items-center gap-2"
                >
            ...
            <div className="space-y-6">
              {isLoadingTemplatePreview ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">Unable to generate template preview for this quote.</p>
                </div>
              )}
              </div>
          </div>
