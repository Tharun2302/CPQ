...
import { Check, Crown, Star, Zap, Award, Shield } from 'lucide-react';
          ...
          return (
            ...
            >
              ...
              <div className="space-y-3 mb-8">
                {calc.tier.features.map((feature, idx) => (
                  <div key={idx} className="flex items-center gap-3 text-sm">
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                      isPremium ? 'bg-purple-100' : isRecommended ? 'bg-green-100' : 'bg-blue-100'
                    }`}>
